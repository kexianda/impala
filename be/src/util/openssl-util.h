...
class EncryptionKey {
 public:
  ...
  /// Specify a cipher mode. Maybe in future we can provide a configuration
  /// option for the end user who can choose a preferred mode(GCM, CTR, CFB...)
  /// based on their software/hardware environment.
